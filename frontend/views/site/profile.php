              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <?php if($model->pp != null){ ?>
                        <img src="<?= Yii::$app->request->baseUrl . '/frontend/web/img/' . $model->pp ?>" alt="Admin" class="rounded-circle" width="150">
                    <?php }else{ ?>
                    ...
                    <div class="mt-3">
                      ...
                      <?php } ?>
                      <?php if($model->id == Yii::$app->user->identity->id){ ?>
                          <?= Html::a('Edit Profile', ['/site/edit_profile', 'id'=>$model->id], ['class'=>'btn btn-outline-primary']) ?>
                      <?php } ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card gedf-card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-2">
                                        <?php if($model->pp != null){ ?>
                                            <img class="rounded-circle" width="45" src="<?= Yii::$app->request->baseUrl . '/frontend/web/img/' . $model->pp ?>" alt="">
                                        <?php }else{ ?>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="like/?id=<?= $post->id?>" class="card-link"><i class="fa fa-gittip"></i><?= ($sumx!= 0)? ' Likes ('.$sumx.')':' Like'; ?></a>
                            <?php $sum = Comments::find()->where(['id_post' => $post->id])->COUNT(); ?>
                            <a href="view/?id=<?= $post->id?>" class="card-link"><i class="fa fa-comment"></i><?= ($sum!= 0)? ' Comments ('.$sum.')':' Comment'; ?></a>
                        </div>
                    </div>
                    <?php } ?>
                    <?php } ?>
